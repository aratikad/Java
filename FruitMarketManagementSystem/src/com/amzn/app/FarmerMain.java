...
public class FarmerMain {
	...
	public static void mainWholeSaler(String[] args) {
		...
		Farmer farmer1 = new Farmer("Lokesh1", (short) 34);
		Farmer farmer2 = new Farmer("Lokesh2", (short) 34);
		Farmer farmer3 = new Farmer("Lokesh3", (short) 34);
		Farmer farmer4 = new Farmer("Lokesh4", (short) 34);
